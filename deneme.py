...
# solver = Solver()
# solver.add(Not(And(Implies(Implies(And(Implies(p,q_atom), Implies(q_atom,r)),Implies(p,r)), Implies(And(Implies(And(b6, b0), b1),
#             Implies(And(b6, b1), b2),
#             Implies(And(b7, b0), b2),
#             Implies(Implies(b6, b7), b5)),
#         b5)), Implies(Implies(And(Implies(And(b6, b0), b1),
#             Implies(And(b6, b1), b2),
#             Implies(And(b7, b0), b2),
#             Implies(Implies(b6, b7), b5)),
#         b5), Implies(And(Implies(p,q_atom), Implies(q_atom,r)),Implies(p,r))))))
# print(solver.check())
# print(solver.model())

# solver = Solver()
# solver.add(Not(Implies(And(Implies(And(p,q_atom,a),c), And((Implies(Implies(a,b0),q_atom)),Implies(Implies(b0, c),p))), c)))
# print(solver.check())
# print(solver.model())